...
public interface HPGraph<NodeType, EdgeType> extends
     ...
     * @param edgeIdx the index of the edge
     * @param index
     * @return the weight associated with the given edge
     */
    public double getMaxEdgeWeight(final int edgeIdx, final int index);
     ...
     * @param index
     */
    public void setMaxEdgeWeight(final int edgeIdx, final double weight, final int index);
