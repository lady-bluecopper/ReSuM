...
import sa.edu.kaust.grami.und.dataStructures.Generic;
import sa.edu.kaust.grami.und.dataStructures.HPListGraph;
import sa.edu.kaust.grami.und.dataStructures.serializableObject;
...
public abstract class SearchLatticeNode<NodeType, EdgeType> implements
    ...
    protected SearchLatticeNode() {
        this.level = -1;
        this.storeValues = new BitSet(Settings.actualNumOfEdgeWeights);
