...
public class GSpanEdge<NodeType, EdgeType> implements
    ...
    protected int edgeLabel, direction;

    protected int ThelabelA, ThelabelB;
     ...
     *
     * @param other
     * @param nodeB this node is used as the second node for the other edge
     * @return <0; 0; or >0
     */
    public final int compareTo(final GSpanEdge<NodeType, EdgeType> other,
        ...
        if (this.nodeA == other.nodeA) {
            ...
            if (this.nodeB == other.nodeA) {
                return -1;
            } else if (other.nodeA > this.nodeA) {
                if (other.nodeA > this.nodeB) {
                    return -1;
                } else {
                    return 1;
                }
            } else if (this.nodeA >= nodeB) {
                return 1;
            } else {
                return -1;
            }
    ...
    public boolean equals(final Object obj) {
        return obj instanceof GSpanEdge && compareTo((GSpanEdge<NodeType, EdgeType>) obj) == 0;
    }

    /**
     * calculates the edge of the given graph that corresponds to this gSpanEdge
